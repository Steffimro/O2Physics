...
struct Photonhbt {
  ...
  struct CrossObs {
    // m(e+e-) of the two leg-swapped combinations, and the smaller of
    // the two divided by q_inv of the photon pair. The RATIO is the
    // discriminator: for a genuine pair m_ee^cross scales with q_inv
    // itself (~0.5 q_inv), for a true leg swap it goes to zero.
